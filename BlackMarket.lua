...
SlashCmdList["BMCOMPAT"] = function()
    ...
    local ver, build, bdate, iface = GetBuildInfo()
    print(string.format("|cffffd700BlackMarket compat:|r version %s  build %s  |cffffd700Interface: %s|r", tostring(ver), tostring(build), tostring(iface)))
